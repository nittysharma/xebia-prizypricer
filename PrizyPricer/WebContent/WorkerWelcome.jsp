...
<body style="background-color: #E8FFDF">
				...
				<div class="col-lg-2 col-lg-offset-2">
					<div class="dropdown">
						<button class="btn btn-info dropdown-toggle" type="button"
							...
							Change Store <span class="caret"></span>
						</button>
				...
				<div class="row">
					...
					<div class=" col-lg-10 col-lg-offset-1">
						...
						<div class="col-lg-9">
							...
							<br /> <br /> <br />
							<br />
							<form action="#" role="form" id="dummy" data-toggle="validator">
								<div class="input-group col-lg-5">
									<span class="input-group-addon">Price</span> <input
										type="number" id="suggestedprice" name="suggestedprice"
										class="form-control" placeholder="Enter Suggested Price" data-validation-required-message="Please enter price its mendatory" required/>
									<span class="input-group-addon">$</span>
								</div>
								<br />
								<div class="input-group col-lg-9 ">
									<span class="input-group-addon">Notes</span>
									<textarea name="note" id="notedes" name="notedes"
										class="form-control" placeholder="Enter Notes Here"></textarea>
								</div>
								<br />
								<button type="button" class="btn btn-success" onclick="submitsurvay();">Submit</button>
							</form>
						</div>
